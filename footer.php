        ...
        <div class="footer">Copyright &copy; <?php echo date('Y'); ?>, <?php echo bloginfo('name');?>. Powered by Wordpress. Theme design by <a href="http://www.zacvineyard.com/">Zac Vineyard</a>.</div>
